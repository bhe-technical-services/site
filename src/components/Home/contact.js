...
function contact() {
    return (
        <section id='contact' className='relative transform -translate-y-36'>
            {/* <svg className="absolute inset-y-0 top-0 inline-block w-full h-full text-flat-gray " fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none">
                <polygon points="0,65 100,0 0,0" />
            </svg> */}
            <div className="z-10 flex flex-col px-10 py-2 space-y-12 md:space-x-10 md:space-y-0 md:flex-row ">
                <div>
                    <h3 className='mb-2 '>
                        <Link to ='/contact'>
