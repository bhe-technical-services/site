...
import {Map, Coffee, Archive, Sunrise, Home, Sun} from 'react-feather'
...
const theOans = [
    ...
    {name: 'Energy', icon: <Sun className='flex-shrink-0 w-6 h-6 mr-4 text-primary-green-600' strokeWidth="3"/>},
]
...
function customers() {
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <h2 className='mb-5 text-center md:mb-10 main-heading text-off-white'>Industries we operate in</h2>
