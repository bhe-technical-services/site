...
function customers() {
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <p className="mx-auto text-base leading-relaxed xl:w-2/4 lg:w-3/4">Text about how we supply multiple industries, with lots of support from these industries below:</p>
        </div>
